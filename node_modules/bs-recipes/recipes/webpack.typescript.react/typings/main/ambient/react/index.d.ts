...
declare namespace __React {
    ...
    interface CSSProperties {
        ...
        /**
         * The text-emphasis property will apply special emphasis marks to the elements text. Slightly similar to the text-decoration property only that this property can have affect on the line-height. It also is noted that this is shorthand for text-emphasis-style and for text-emphasism-color.
         */
        textEmphasis?: any;

        /**
         * The text-emphasism-color property specifies the foreground color of the emphasis marks.
         */
