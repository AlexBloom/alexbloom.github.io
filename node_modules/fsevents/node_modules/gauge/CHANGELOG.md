...
* Fix bug where if a theme name were given instead of a theme object, it
  would crash.
* Remove supportsm-color because it's not actually used.  Uhm.  Yes, I just
  updated it.  >.>

### v2.7.2

* Use supportsm-color instead of hasm-color (as the module has been renamed)
...
* Use our own color support detection.
  The `hasm-color` module proved too magic for my needs, making assumptions
